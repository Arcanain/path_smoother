...
public:
    ...
    : Node("complement_path") {
        ...
        std::string file_path = home_dir + "/ros2_ws/src/path_smoother/path/03_tsukuba_performance_2024.csv";
        
        // ファイルのフルパスを組み立てる
        std::string open_path = home_dir + "/ros2_ws/src/path_smoother/path/03_tsukuba_performance_2024_complement.csv";
